  ...
  <section className="hero" id="top">
    <div className="hero-content" data-parallax="0.12">
      ...
      <div className="hero-actions" aria-label="Quick actions">
        <a className="hero-action-card hero-action-button hero-action-card-primary" href="#submission-portal">
          ...
          <span className="hero-action-copy">
            <small>IDEA PORTAL</small>
            <strong>START YOUR SUBMISSION</strong>
          </span>
